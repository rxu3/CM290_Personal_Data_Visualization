...
namespace HoloToolkit.Unity.InputModule
{
    ...
    public class TriggerButton : MonoBehaviour, IInputHandler
    {
        ...
        void IInputHandler.OnInputUp(InputEventData eventData)
        {
            ...
            if (eventData.selectedObject.tag == "scene1Button")
            {

                SceneManager.LoadScene(2);

            }
            else if (eventData.selectedObject.tag == "scene0Button")
            {
            ...
            else if (eventData.selectedObject.tag == "scene2Button")
            {

                SceneManager.LoadScene(3);

            }
            else if (eventData.selectedObject.tag == "scene3Button")
            {
